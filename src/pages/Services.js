...
const Services = () => {
  ...
  return (
    <div className="App">
      ...
      <h1>Services Page</h1>
      <h3>Our Objective</h3>
      <p>Our first and most important goal is to establish a communal trust between houseless encampments and Undergraduate Street Medicine Outreach (USMO) members. Through regularly scheduled outreach and interacting with clients, we hope to build a meaningful relationship with the houseless community beyond our duties such that we can most effectively help them attain the services they need.</p>
